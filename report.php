...
if ($ctype == 'M') {
    ...
    for ($x = 0; $x <= 1; $x++) {
         ...
         $all = block_questionreport_get_question_results($ctype, $pnum, 0, 0, $moduleid, $tagid, $start_date, $end_date, $partner);
    ...
    for($x =0; $x <=1; $x++) {
         ...
         $all = block_questionreport_get_question_results($ctype, $x, 0, 0, $moduleid, $tagid, $start_date, $end_date, $partner);
         // Build object from data and assign it to the $data object passed to the template.
         if ($x == 0) {
