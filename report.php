...
echo html_writer::select($courselist,"id",$cid, false);
...
$sqlcourse = "SELECT m.course, m.id
...
if ($quest) {
    ...
    $content .= html_writer::start_tag('tr');
    $content .= html_writer::start_tag('td');
    $content .= 'S/he facilitated the content clearly.';
    $content .= html_writer::end_tag('td');
    $content .= html_writer::start_tag('td');
    $content .= '9';
    $content .= html_writer::end_tag('td');
    ...
    $content .= html_writer::start_tag('tr');
    $content .= html_writer::start_tag('td');
    $content .= 'S/he effectively built a community of learners.';
    $content .= html_writer::end_tag('td');
    $content .= html_writer::start_tag('td');
    $content .= '42';
    $content .= html_writer::end_tag('td');
    ...
    $arr = array('I am satisfied with the overall quality of this course.',
                 'The topics for this course were relevant for my role.',
                 'The topics for this course were relevant for my role.',
                 'The topics for this course were relevant for my role.',
                 'This course helped me prepare for school opening after COVID-19.',
